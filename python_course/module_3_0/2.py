...
#
#
# Здесь вызывается одноимённый метод timeit, в котором нужный фрагмент кода записывается в кавычках (или апострофах). Именованный аргумент number отвечает за время 10 000 выполнений кода.
#
